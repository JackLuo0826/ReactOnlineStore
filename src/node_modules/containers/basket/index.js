                    ...
                    <tbody>
                        {products.map((product, index) => (
                            <tr key={index} className="item-checkout">
                                ...
                                <td className="col-md-6">{product.name}</td>
                                <td className="col-md-3">${product.price}</td>
                                <td className="col-md-1">{product.count}</td>
                                <td>
                                    <span className="delete-cart" onClick={() => removeProductFromBasket(product.id)}></span>
                                </td>
                            </tr>
                        ))}
                    </tbody>
        ...
        <div>
            ...
            </Link>
            {
                ...
                <div>
                    ...
                    <button className="btn btn-success" onClick={() => basketCheckout(products)}>
